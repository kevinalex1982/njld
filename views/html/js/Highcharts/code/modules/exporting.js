...
(function (m) {
    ...
    (function (f) {
        var m = f.defaultOptions, n = f.doc, u = f.Chart, v = f.addEvent, D = f.removeEvent, E = f.fireEvent, r = f.createElement, B = f.discardElement, w = f.css, q = f.merge, C = f.pick, h = f.each, t = f.extend, G = f.splat, H = f.isTouchDevice, F = f.win, I = f.Renderer.prototype.symbols;
        t(m.lang, {
        ...
        f.post = function (a, b, e) {
            var c;
            a = r("form", q({method: "post", action: a, enctype: "multipart/form-data"}, e), {display: "none"}, n.body);
        ...
        t(u.prototype, {
            sanitizeSVG: function (a) {
                ...
                var b = this, e,
                    c, g, x, k, d = q(b.options, a), p = d.exporting.allowHTML;
                ...
                return this.getSVG(q({chart: {borderRadius: 0}}, e.chartOptions, b,
                    {
                        exporting: {
                ...
                l || (d[x] = l = r("div", {className: a}, {
                    position: "absolute",
                    zIndex: 1E3,
                    padding: y + "px"
                }, d.container), z = r("div", {className: "highcharts-menu"}, null, l), w(z, t({
                ...
                if (!1 !== c.enabled) {
                    ...
                    c.symbol && (k = e.symbol(c.symbol, c.symbolX - p / 2, c.symbolY - p / 2, p, p).addClass("highcharts-button-symbol").attr({zIndex: 1}).add(d), k.attr({
                        stroke: c.symbolStroke,
                        fill: c.symbolFill,
                        "stroke-width": c.symbolStrokeWidth || 1
                    }));
                    d.add().align(t(c, {width: d.width, x: C(c.x, b.buttonOffset)}), !0, "spacingBox");
